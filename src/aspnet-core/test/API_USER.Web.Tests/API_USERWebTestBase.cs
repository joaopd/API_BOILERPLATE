...
{
    public abstract class API_USERWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static API_USERWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(API_USERWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<API_USERDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<API_USERDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<API_USERDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<API_USERDbContext, Task<T>> func)
        {
            T result;
