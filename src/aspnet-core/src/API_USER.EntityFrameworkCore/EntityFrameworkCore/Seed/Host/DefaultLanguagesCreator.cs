...
namespace API_USER.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly API_USERDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = API_USERConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(API_USERDbContext context)
        {
            _context = context;
        }
